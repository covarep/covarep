...
% Function to detect regions in speech signals containing creak/vocal fry.
% The method is as described in Ishi et al. (2008). 

% USAGE: INPUT       
%        x          - speech signal
%        fs         - sampling frequency
%        plots      - 1 for plots (optional)
%
%        OUTPUT
%        creak      - creak decision as binary vector
%
% REFERENCE:
